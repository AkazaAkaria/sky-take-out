...
CREATE TABLE `operate_log` (
                               ...
                               `operate_id` int unsigned DEFAULT NULL COMMENT '操作人id',
                               `operate_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '操作人',
                               ...
                               `method_params` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '方法的参数',
                               `return_value` varchar(10000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '返回值',
                               `cost_time` bigint DEFAULT NULL COMMENT '方法执行耗时,单位ms',
                               `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                               PRIMARY KEY (`id`)
